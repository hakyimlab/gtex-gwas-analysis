...
- `r n_smultixcan_genes_eqtl` significant s-multixcan genes in Elastic Expression models
...
- `r n_models_gt_pairs_eur_sqtl` `(gene, tissue)` pairs in Elastic Expression models
- `r n_models_genes_sqtl_eur` genes in Elastic Expression models
- `r n_spredixcan_genes_sqtl` significant s-predixcan genes in Elastic Expression models
- `r n_spredixcan_tuples_sqtl` S-PrediXcan tuples in expression models
- `r n_smultixcan_genes_sqtl` significant s-multixcan genes in Elastic Expression models
- `r n_smultixcan_tuples_sqtl` S-MultiXcan tuples in expression models
