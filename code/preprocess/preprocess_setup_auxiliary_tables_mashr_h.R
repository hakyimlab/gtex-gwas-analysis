...
sp_count(predixcan_mashr_hq_tbl_eqtl, predixcan_mashr_hq_tbl_count_eqtl, "expression_b_mashrhq.txt")
sp_count(predixcan_mashr_hn_tbl_eqtl, predixcan_mashr_hn_tbl_count_eqtl, "expression_b_mashrhn.txt")
