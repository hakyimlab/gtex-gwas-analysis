#!/bin/bash
#PBS -N 50_standing_height_chr21_sb3_by_region
#PBS -S /bin/bash
...
-parquet_genotype /gpfs/data/im-lab/nas40t2/abarbeira/projects/gtex_v8/data_formatting/model_training_to_parquet/results/parquet_eur_maf0.01_biallelic/gtex_v8_eur_itm.chr21.variants.parquet \
...
-sub_batch 3 \
--standardise_dosages \
-output results_summary_imputation/50_standing_height_chr21_sb3_reg0.1_ff0.01_by_region.txt.gz